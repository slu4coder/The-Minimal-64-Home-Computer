...
; ---------------
; 0xb000 - 0xbcff   4KB OS kernel
; 0xbd00 - 0xbeff   OS commands
...
#org 0xb000			endsrc:				; end of source vector

#org 0xbcb5     _PtrA:        ; lokaler OS pointer (3 bytes) used by LoadFileTo routine
#org 0xbcb8     _PtrB:        ; lokaler OS pointer (3 bytes)
#org 0xbcbe     _PtrD:        ; lokaler pointer (2 bytes)
